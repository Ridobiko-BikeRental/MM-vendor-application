...
class OrderDeliverdScreen extends StatefulWidget {
  const OrderDeliverdScreen({super.key});

  @override
  State<OrderDeliverdScreen> createState() => _OrderDeliveredScreenState();
}

class _OrderDeliveredScreenState extends State<OrderDeliverdScreen> {
  @override
  void initState() {
    super.initState();
