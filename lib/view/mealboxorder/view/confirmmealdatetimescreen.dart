...
class ConfirmMealDateTime extends StatefulWidget {
  ...
  @override
  State<ConfirmMealDateTime> createState() => _ConfirmMealDateTimeState();
}

class _ConfirmMealDateTimeState extends State<ConfirmMealDateTime> {
  ...
  Future<void> _pickDate() async {
    ...
    int days = int.tryParse(match?.group(0) ?? '') ?? 1;
    log("$days");
